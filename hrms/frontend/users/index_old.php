...
// Fetch employees with their department, designation, and today's attendance status
$sql = "
    SELECT u.id, u.full_name as name, u.email, u.phone, u.role, u.is_active, u.designation_id,
           d.name as dept,
...
<div class="flex items-center gap-3 mb-4">
    <form action="<?= BASE_URL ?>index.php" method="GET" class="flex-1 relative">
        ...
        <input type="text" name="q" value="<?= htmlspecialchars($search) ?>" placeholder="Search employees…" class="border border-border rounded-full h-9 pl-10 pr-4 text-[13px] focus:border-primary outline-none flex-1 w-full">
    </form>
    <div class="relative">
    ...
    <div class="kanban-card">
        <div class="flex items-start gap-3">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="caption"><?= htmlspecialchars($emp['designation_name'] ?: 'Team Member') ?> • <?= htmlspecialchars($emp['dept']) ?></p>
